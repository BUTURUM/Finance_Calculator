<template>
  <Model v-model="open">
    <form @submit.prevent="submit" class="*:not-last:mb-2.5">
      <input class="standard-input w-full" v-model="data.title" placeholder="title" type="text"/>
      <input class="standard-input w-full" v-model="data.amount" placeholder="amount" step="0.01" type="number"/>
      <div class="flex">
